async function API(){
    ...
    cell2.innerHTML = "User Name "+username
    cell3.innerHTML = "Email "+email
    cell4.innerHTML = "Location "+location
    cell5.innerHTML = "Gists "+gists
    cell6.src = avatar
    ...
    // let repoTable = document.getElementById(TheRepo);
    // for (let index = 0; index < repo.length; index++) {
    //     let tr = document.createElement("tr");
    //     let repoName = document.createElement("td");
    //     repoName.innerHTML = repo[index];
    //     tr.appendChild(repoName);
